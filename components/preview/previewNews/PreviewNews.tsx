  ...
  return (
    <article>
      ...
      <div className={styles.buttonsBlock}>
        <Button type='default' text={/*t('back')*/ 'back'} callback={onCancel} className={styles.button} />
        {/*userStore.isModerator*/ true &&
          <Button type='secondary' text={/*t('edit')*/ 'edit'} callback={onRedact} className={styles.button} />
        }
      </div>
    </article>
  )
